const fs = require("fs");
const targetPath = "C:/Users/tuinkabouter/Desktop/bulterS-vite/electron.cjs";

const code = `const { app, BrowserWindow, dialog, Menu } = require("electron");
...
console.log("OK electron.cjs herschreven, size:", code.length);
